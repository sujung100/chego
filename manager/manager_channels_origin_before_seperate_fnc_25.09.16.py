...
class TestConsumer(AsyncWebsocketConsumer):
    ...
    async def receive(self, text_data):
        ...
        try:
            ...
            dayoff = await sync_to_async(get_object_or_404)(rsv.Dayoff, pk=rsv_id)
        ...
        elif key_command == "rsv_renewal_cycle":
            # 예약 갱신 주기 설정 - 기간설정(자동)
        ...
        #     await sync_to_async(store.save)()
        #     await sync_to_async(dayoff.save)()
