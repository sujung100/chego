...
websocket_urlpatterns = [
    ...
    re_path(r"manager/hs/admin_cube/$", admin_channels.AdminChatConsumer.as_asgi()),
    ...
    # re_path(r"manager/admin_cube/(?P<room_name>[\w]+)/$", admin_channels.AdminChatConsumer.as_asgi()),
    re_path(r"manager/hs/admin_chat2/(?P<room_name>[\w]+)/$", admin_channels.AdminChatConsumer.as_asgi()),
    re_path(r"manager/admin_home/(?P<room_name>[\w.]+)/$", admin_channels.AdminChatConsumer.as_asgi()),
